#
# Module manifest for module 'CloudScope.Core'
#
# Generated by: CloudScope Team
#
...
RootModule = 'CloudScope.Core.psm1'
...
Description = 'Core module for CloudScope compliance monitoring framework'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Compliance', 'Security', 'Microsoft365', 'Azure')
        ...
        ReleaseNotes = 'Initial release of CloudScope Core module'
